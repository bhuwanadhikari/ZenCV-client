...
- stretch the paragraphs in the cover letter and cv to make it appear better
- make default drawer closed
- redflag if mismatch with cv and the requirement like [ language, full/partime, location, salary, tech stacks etc]
- make the page title compact
